...
class _MenuItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color textColor = enabled
        ...
        : theme.colorScheme.secondary.withAlpha(0xCC);
    final Color selectedColor = enabled ? Colors.transparent : theme.focusColor;
                        ...
                        if (width < railWidth + 10)
                          ...
                          Text(
                            ...
                            style: theme.textTheme.bodyLarge!.copyWith(
                                color: textColor,
                                fontWeight: enabled ? null : FontWeight.bold),
                          )
                      ],
                    ),
                  ),
                      ...
                      TextButton(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Text('Log Out', style: textTheme.labelSmall),
                          ],
                        ),
                      ),
